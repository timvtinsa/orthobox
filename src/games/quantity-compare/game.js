...
export default {
  ...
  settings: [
    {
      ...
      options: [
        ...
        { id: 'medium', label: 'Quantités moyennes', hint: 'De 4 à 14 points.' },
        { id: 'estimation', label: 'Estimation', hint: 'Les points disparaissent au bout d’un instant.' },
        { id: 'transcoding', label: 'Points et chiffres', hint: 'Une collection face à un nombre écrit.' },
      ],
    },
    {
      id: 'rounds',
  ...
  component: lazy(() => import('./QuantityCompare.jsx')),
}
