  ...
  settings: [
    {
      ...
      default: 'facile',
      options: [
        { id: 'facile', label: 'Facile', hint: '3 paires, 6 cartes.' },
        { id: 'moyen', label: 'Moyen', hint: '6 paires, 12 cartes.' },
        { id: 'difficile', label: 'Difficile', hint: '10 paires, 20 cartes.' },
      ],
    },
    {
      id: 'observation',
      ...
      hint: 'Durée d’affichage d’une paire ratée, en dixièmes de seconde.',
      min: 5,
      max: 40,
      step: 5,
      default: 12,
