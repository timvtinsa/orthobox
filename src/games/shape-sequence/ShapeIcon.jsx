/**
 * The shapes of the board, drawn flat with a constant dark outline: colour
 * names the cell, the outline keeps it legible without it — which is also
 * what keeps a white shape as visible as any other.
 */
...
export default function ShapeIcon({ shapeId, hex, size = 36 }) {
  return (
