...
const PATHS = {
  ...
  heart: (
    <path d="M12 21s-6.7-4.35-9.3-8.28C1.2 10.4 1.6 7.4 4 5.6c2-1.5 4.6-1.1 6 .7l2 2.5 2-2.5c1.4-1.8 4-2.2 6-.7 2.4 1.8 2.8 4.8 1.3 7.12C18.7 16.65 12 21 12 21z" />
  ),
  settings: (
    <>
      <path
